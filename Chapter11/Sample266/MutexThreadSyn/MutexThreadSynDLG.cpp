// MutexThreadSynDlg.cpp : implementation file
//

#include "stdafx.h"
#include "MutexThreadSyn.h"
#include "MutexThreadSynDlg.h"
#include <afxmt.h>
#ifdef _DEBUG
...
CMutexThreadSynDlg::CMutexThreadSynDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CMutexThreadSynDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMutexThreadSynDlg)
...
void CMutexThreadSynDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMutexThreadSynDlg)
	DDX_Control(pDX, IDC_EDIT2, m_ReadEdit);
	DDX_Control(pDX, IDC_EDIT1, m_WriteEdit);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CMutexThreadSynDlg, CDialog)
	//{{AFX_MSG_MAP(CMutexThreadSynDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CMutexThreadSynDlg message handlers

BOOL CMutexThreadSynDlg::OnInitDialog()
{
...
void CMutexThreadSynDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMutexThreadSynDlg::OnPaint() 
{
	if (IsIconic())
	{
...
HCURSOR CMutexThreadSynDlg::OnQueryDragIcon()
{
