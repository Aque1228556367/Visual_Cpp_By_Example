...
void CGetFilePathDlg::OnCurrent() 
{
	// TODO: Add your control notification handler code here
	if(!GetCurrentDirectory(50,(LPTSTR)(LPCTSTR)m_strPath))//获取当前目录
		AfxMessageBox("获取当前目录失败");		
	UpdateData(false);
}


void CGetFilePathDlg::OnWindows() 
{
	// TODO: Add your control notification handler code here
	if(!GetWindowsDirectory((LPTSTR)(LPCTSTR)m_strPath,50))//获取Windows目录
		AfxMessageBox("获取Windows目录失败");		
	UpdateData(false);	
}

void CGetFilePathDlg::OnSystem() 
{
	// TODO: Add your control notification handler code here
	if(!GetSystemDirectory((LPTSTR)(LPCTSTR)m_strPath,50))//获取系统目录
		AfxMessageBox("获取系统目录失败");		
	UpdateData(false);	
