// GetHostNameIPDlg.cpp : implementation file
//
...
CGetHostNameIPDlg::CGetHostNameIPDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CGetHostNameIPDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CGetHostNameIPDlg)
	m_strName = _T("");
	m_strIP = _T("");
	//}}AFX_DATA_INIT
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CGetHostNameIPDlg)
	DDX_Text(pDX, IDC_EDIT1, m_strName);
	DDX_Text(pDX, IDC_EDIT2, m_strIP);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CGetHostNameIPDlg, CDialog)
	//{{AFX_MSG_MAP(CGetHostNameIPDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CGetHostNameIPDlg message handlers
