// ListCtrlStyleDlg.cpp : implementation file
//

#include "stdafx.h"
#include "ListCtrlStyle.h"
#include "ListCtrlStyleDlg.h"
...
CListCtrlStyleDlg::CListCtrlStyleDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CListCtrlStyleDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CListCtrlStyleDlg)
	m_edit = _T("");
	m_radio = 0;
	m_static = _T("");
	m_radio2 = 2;
...
void CListCtrlStyleDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CListCtrlStyleDlg)
...
BEGIN_MESSAGE_MAP(CListCtrlStyleDlg, CDialog)
	//{{AFX_MSG_MAP(CListCtrlStyleDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CListCtrlStyleDlg message handlers

BOOL CListCtrlStyleDlg::OnInitDialog()
{
...
void CListCtrlStyleDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CListCtrlStyleDlg::OnPaint() 
{
	if (IsIconic())
	{
...
HCURSOR CListCtrlStyleDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CListCtrlStyleDlg::OnButton1() 
{
...
void CListCtrlStyleDlg::OnItemchangedList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
