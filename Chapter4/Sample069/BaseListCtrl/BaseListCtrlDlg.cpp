// BaseListCtrlDlg.cpp : implementation file
//

#include "stdafx.h"
#include "BaseListCtrl.h"
#include "BaseListCtrlDlg.h"
...
CBaseListCtrlDlg::CBaseListCtrlDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CBaseListCtrlDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CBaseListCtrlDlg)
	m_edit = _T("");
	m_radio = 0;
	m_static = _T("");
	//}}AFX_DATA_INIT
...
void CBaseListCtrlDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CBaseListCtrlDlg)
...
BEGIN_MESSAGE_MAP(CBaseListCtrlDlg, CDialog)
	//{{AFX_MSG_MAP(CBaseListCtrlDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CBaseListCtrlDlg message handlers

BOOL CBaseListCtrlDlg::OnInitDialog()
{
...
void CBaseListCtrlDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CBaseListCtrlDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CBaseListCtrlDlg::OnButton1() 
{
...
void CBaseListCtrlDlg::OnItemchangedList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
