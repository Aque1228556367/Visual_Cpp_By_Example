...
int CMyMCIVideo::Open(CString FileName, CWnd* pWnd, int left, int top, int width, int height)
{
...
int CMyMCIVideo::Play(int Loop, int FullScreen)
{
	if (m_bOpen)
	{
		// 如果是视频的尾部则重新开始播放
